...
<div class="bg-gray-500 w-full flex justify-center h-[149px] content-center">
	<div class="content-center">
		<div class="flex gap-x-10">
			<a class="flex" href="https://web.facebook.com/angelo.auxtero.3"
				><svg
			...
			<a class="flex" href="mailto:yourname@example.com"
				><svg
					xmlns="http://www.w3.org/2000/svg"
					width="24"
					height="24"
