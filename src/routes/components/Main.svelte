<script>
	let reminderText = '';
	const webhookUrl =
		'https://discord.com/api/webhooks/1249573774853013590/eUgsURxpS85JUTHrCA_9e0gyrGlSeAqoRY8Y4E8x9CrSC2PSZm-YTrWZQZFR8io0sPas';
	...
	<div class="flex gap-x-10 w-full">
		...
		<div class="justify-center w-full h-[470px] rounded">
			...
			<div class="flex gap-x-2 justify-center">
				...
				/>
				<button on:click={sendToDiscord(reminderText)} class="h-[48px] bg-gray-500 p-2 rounded"
					>Save</button
				>
			</div>
		</div>
